...
set_property PACKAGE_PIN V3 [get_ports {ComparatorOut[0]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ComparatorOut[0]}]
set_property PACKAGE_PIN W3 [get_ports {ComparatorOut[1]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ComparatorOut[1]}]
set_property PACKAGE_PIN U3 [get_ports {ComparatorOut[2]}]
	set_property IOSTANDARD LVCMOS33 [get_ports {ComparatorOut[2]}]
